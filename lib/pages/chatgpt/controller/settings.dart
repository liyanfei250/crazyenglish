...
class SettingsController extends GetxController {
  ...
  final openAiKey = "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".obs;
  ...
  getOpenAiKeyFromPreferences() async {
    GetStorage _box = GetStorage();
    String key = _box.read('openAiKey') ?? "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";
    setOpenAiKey(key);
  }
