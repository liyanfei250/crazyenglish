 ...
 */
class CompleteFillingQuestionResult extends BaseQuestionResult {
  SubjectVoList data;

  CompleteFillingQuestionResult(Map<String,ExerciseLists> subtopicAnswerVoMap,int childIndex,{required this.data,Key? key}) : super(subtopicAnswerVoMap,childIndex,key: key);

  @override
  BaseQuestionResultState<CompleteFillingQuestionResult> getState() => _CompleteFillingQuestionResultState();

}

class _CompleteFillingQuestionResultState extends BaseQuestionResultState<CompleteFillingQuestionResult> {
  ...
  Widget getDetail(int defaultIndex){
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        mainAxisSize: MainAxisSize.min,
        children: [
          QuestionFactory.buildSelectFillingQuestion(element,makeFocusNodeController,widget.subtopicAnswerVoMap,isResult: true),
        ],
      ),
    );
  }
