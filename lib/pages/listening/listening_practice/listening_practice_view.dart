      ...
      body: Container(
          ...
          child: Container(
            ...
            padding: EdgeInsets.only(
                left: 14.w, right: 14.w, top: 14.w, bottom: 14.w),
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    Text('七年级 新课程 第29期｜共4篇',style: TextStyle(fontSize: 12,color: Color(0xff858aa0),fontWeight: FontWeight.w400),),
                    Expanded(child: Text('')),
                    Text('期刊成绩',style: TextStyle(fontSize: 12,color: Color(0xff353e4d),fontWeight: FontWeight.w600)),
                    Image.asset(
                      R.imagesIconToNext,
                      fit: BoxFit.cover,
                      width: 7.w,
