...
class RectangleSwiperIndicator extends _SwiperIndicator {
  RectangleSwiperIndicator({
    ...
    bool hideLast = false,
          ...
          normalHeight: itemHeight,
          normalBoxDecoration:
              BoxDecoration(color: itemColor, shape: BoxShape.rectangle),
          selectBoxDecoration:
              BoxDecoration(color: itemActiveColor, shape: BoxShape.rectangle),
          // itemColor: itemColor,
          selectWidth: itemWidth,
          selectHeight: itemHeight,
...
class CircleSwiperIndicator extends _SwiperIndicator {
  CircleSwiperIndicator({
    ...
    bool hideLast = false,
          ...
          spacing: spacing,
          // itemColor: itemColor,
          normalHeight: radius * 2,
          normalWidth: radius * 2,
          normalBoxDecoration:
              BoxDecoration(color: itemColor, shape: BoxShape.circle),
          selectBoxDecoration:
              BoxDecoration(color: itemActiveColor, shape: BoxShape.circle),
          selectHeight: radius * 2,
          selectWidth: radius * 2,
          // itemActiveColor: itemActiveColor,
...
class CustomSwiperIndicator extends _SwiperIndicator {
  CustomSwiperIndicator({
    EdgeInsetsGeometry? padding,
    double spacing = 6.0,
    required double normalWidth,
    required double normalHeight,
    required BoxDecoration noralBoxDecoration,
    required double selectWidth,
    required double selectHeight,
    required BoxDecoration selectBoxDecoration,
    bool hideLast = false,
  }) : super(
          padding: padding,
          spacing: spacing,
          ...
          normalBoxDecoration: noralBoxDecoration,
          selectWidth: selectWidth,
          selectHeight: selectHeight,
          selectBoxDecoration: selectBoxDecoration,
          hideLast: hideLast,
        );
}
...
class _SwiperIndicator implements SwiperIndicator {
  _SwiperIndicator({
    ...
    required this.selectBoxDecoration,
    required this.normalWidth,
    required this.normalHeight,
    required this.normalBoxDecoration,
    this.padding,
    required this.hideLast,
  });
  ...
  final selectBoxDecoration;

  final double normalWidth;
  final double normalHeight;
  final normalBoxDecoration;
  ...
  @override
  Widget build(BuildContext context, int index, int itemCount) {
    if (hideLast && (itemCount == 1 || (index + 1) == itemCount)) {
    ...
    return Padding(
      ...
      child: Wrap(
        ...
        children: List.generate(itemCount, (_index) {
          ...
          // }
          return Container(
            width: _index == index ? selectWidth : normalWidth,
            height: _index == index ? selectHeight : normalHeight,
            decoration:
                _index == index ? selectBoxDecoration : normalBoxDecoration,
          );
        }),
      ),
    );
...
class _SwiperState extends State<Swiper>
  ...
  void _init() {
    ...
    _pageController = PageController(
        initialPage: _index, viewportFraction: widget.viewportFraction);
